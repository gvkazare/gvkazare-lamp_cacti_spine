...
<head>
    <meta charset=utf-8>
    <title>Hello World from Cacti LAMP</title>
...
<body>
    <div class="container">
        <header>
            <h2>Welcome to:</h2>
            <h1>gvkazare/lamp_cacti_spine</h1>
        </header>
        <article>
            <p>
                For documentation, <a href="https://github.com/gvkazare/lamp_cacti_spine" target="_blank">click here</a>.
            </p>
        </article>
        <section>
            <pre>
