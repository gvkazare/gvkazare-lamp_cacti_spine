...
echo "=> /usr/bin/mysqld_safe > /dev/null 2>&1 &"
...
#PASS=${MYSQL_ADMIN_PASS:-$("Cwerjgfhjkm1"}
...
echo ""
echo "    mysql -uadmin -p$PASS -h<host> -P<port>" >> /var/log/mysql/log.log
...
echo "=> Start /create_mysql_cacti.sh"
/create_mysql_cacti.sh
echo "=> Finish /create_mysql_cacti.sh"
